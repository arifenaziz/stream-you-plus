...
import * as authAction from '../../../src/store/actions/authSignup';

const Signup = () => {



   const authLoading=useSelector(state=>state.authSignup.loading);
   const authError=useSelector(state=>state.authSignup.error);
   const isAuthenticated=useSelector(state=>state.authSignup.token !== null);
...
if(isAuthenticated){
   afterSignup=<p className={classes.Success}>Your account created successfully</p>
}
                  ...
                  <div className="login-main-left">
                     ...
                     <form onSubmit={contactFormProcess}>
                       ...
                       {form}
                        ...
                        <div className="mt-4">
                           <button type="submit" className="btn btn-outline-primary btn-block btn-lg" disabled={!formsConfig.formIsValid}>Sign Up</button>
                        </div>
                     ...
                     <div className="text-center mt-5">                        
                        <p className="light-gray">Already have an Account? <Link to="/signin"> Signin </Link> </p>
                     </div>
